export const altarStonesAreaData = {
  ...
  conditions: ``,
  approach: `Park at Altar Stones Ln, Markfield LE67 9PX (52.6931, -1.2854). The footpath leads directly to the Altar Stones.`,
  access: ``,
  gpsCoordinates: `52.6931, -1.2854`,
  blocks: [
    {
      name: `the-altar`,
      displayName: `The Altar`,
      ...
      access: ``,
      gpsCoordinates: `52.693861, -1.284661`,
      sections: [
        {
          name: `front-side`,
    ...
    {
      name: `holly-area`,
      displayName: `Holly Area`,
      overview: `Hidden away at the north east of the crag close to a dry stone wall.`,
      conditions: ``,
      approach: `The closest parking is the Hunts Hill Car Park LE6 0AH.`,
      access: ``,
      gpsCoordinates: `52.69392, -1.28425`,
      sections: [
        {
          name: `front-side`,
          displayName: `Front Side`,
